...
export type Database = {
  public: {
    Tables: {
      ...
      lesson_sections: { Row: { id: string; lesson_id: string; title: string; order_index: number; status: string; default_cci_standard_card_id: string | null; created_at: string; updated_at: string } };
